...
#   theme_minimal() +
#   labs(
#     title = "Expected outbreak size",
#     fill = "Persons"
#   )
# 
# # save to file
# ggsave("Figures/expected_outbreak_size.png",
#        plot = p_expected_size,
#        width = 10,
#        height = 8, 
#        dpi = 300
# )
...
# 
# # save to file
# ggsave("Figures/expected_attack_rate.png",
#        plot = p_expected_attackrate,
#        width = 10,
#        height = 8, 
#        dpi = 300
# )
...
#   mutate(
#     perc_diff_attack_rate1 = ifelse(
#       expected_attack_rate == 0,
#       0,
#       100 * ((expected_attack_rate - expected_attack_rate1) / expected_attack_rate)
#     ),
#     perc_diff_attack_rate2 = ifelse(
#       expected_attack_rate == 0,
#       0,
#       100 * ((expected_attack_rate - expected_attack_rate2) / expected_attack_rate)
#     ),
#     perc_diff_attack_rate3 = ifelse(
#       expected_attack_rate == 0,
#       0,
#       100 * ((expected_attack_rate - expected_attack_rate3) / expected_attack_rate)
#     )
#   )
...
#     name = "Change"
#   ) +
#   labs(title = "Scenario 1 vs Current") +
#   theme(
...
#     name = "Change"
#   ) +
#   labs(title = "Scenario 2 vs Current") +
#   theme(
#     panel.background = element_rect(fill = "white", color = NA),
#     plot.background  = element_rect(fill = "white", color = NA),
#     panel.grid.major = element_blank(),
...
# 
# legend <- get_legend(
#   p1 + theme(legend.position = "right", legend.title = element_text(size = 10))
# )
# 
# row_plot <- plot_grid(
#   p1,
...
#   #align = "hv"
#   )
# #final_plot <- plot_grid(row_plot, legend, nrow = 1, rel_widths = c(3, 0.4))
# 
# file_name <- paste0("Figures/figure_02_attackrate_difference_18_absrev01.png")
# ggsave(file_name, row_plot, width = 10, height = 10, dpi = 400)
# 
# 
...
# 
# p1 <- ggplot(infection_district_scenario) +
#   geom_sf(aes(fill = MMR1 - MMR), color = "gray40",) + 
#   geom_sf(
#     data = tx_counties,
#     fill = NA,
#     color = "gray20",
...
# 
# p2 <- ggplot(infection_district_scenario) +
#   geom_sf(aes(fill = MMR2 - MMR), color = "gray40",) + 
#   geom_sf(
#     data = tx_counties,
#     fill = NA,
#     color = "gray20",
...
# 
# p3 <- ggplot(infection_district_scenario) +
#   geom_sf(aes(fill = MMR3 - MMR), color = "gray40",) + 
#   geom_sf(
#     data = tx_counties,
#     fill = NA,
#     color = "gray20",
...
# )
# 
# row_plot <- plot_grid(p1, p2, p3, nrow = 1, align = "hv")
# final_plot <- plot_grid(row_plot, legend, nrow = 1, rel_widths = c(3, 0.4))
# 
# file_name <- paste0("Figures/figure_02_MMR.png")
# ggsave(file_name, row_plot, width = 6 * 3, height = 6, dpi = 400)
# 
